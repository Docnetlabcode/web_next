...
const SECTIONS = [
  {
    ...
    body: (
      <>
        <p>Welcome to DokLynk.</p>
        <p>These Terms of Use ("Terms") govern your access to and use of the DokLynk website, mobile applications, and related services (collectively, the "Platform").</p>
        <p>By creating an account, accessing, or using DokLynk, you acknowledge that you have read, understood, and agreed to be bound by these Terms. If you do not agree with these Terms, you must not use the Platform.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>DokLynk is a healthcare-focused networking, communication, collaboration, and knowledge-sharing platform designed for:</p>
        ...
        <p>DokLynk is not a hospital, clinic, healthcare provider, emergency service, insurance provider, or medical institution.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>By using DokLynk, you represent and warrant that you meet these requirements.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>DokLynk currently supports three user categories:</p>
  ...
  },
  {
    ...
    body: (
      <>
        <p>Users may create accounts using approved authentication methods provided by DokLynk. You agree to:</p>
        <Bullets items={[
          "Provide accurate information",
          "Keep information updated",
          "Protect your login credentials",
          "Maintain account security",
          "Notify DokLynk of unauthorized access",
        ]} />
        <p>You are solely responsible for activities occurring under your account. DokLynk reserves the right to suspend or restrict accounts that violate these Terms.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>Verification is granted solely at DokLynk's discretion. DokLynk reserves the right to:</p>
        <Bullets items={[
        ...
        <p>Verification confirms only that submitted information has been reviewed through DokLynk's verification process. Verification does not constitute:</p>
        <Bullets items={[
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>By publishing content on DokLynk, you grant DokLynk a worldwide, non-exclusive, royalty-free license to host, display, reproduce, distribute, process, and make such content available solely for operating, maintaining, improving, and promoting the Platform.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>DokLynk reserves the right to remove content that violates these Terms or Community Guidelines.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <Note>DokLynk's final policy regarding patient information, clinical images, medical records, case study publication requirements, and de-identification standards is currently under review and may be further defined through Community Guidelines and future policies.</Note>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>DokLynk provides communication features that may include direct messaging, connection requests, notifications, calling features, and professional networking interactions.</p>
  ...
  },
  {
    ...
    body: (
      <>
        <p>DokLynk may offer paid features, subscriptions, consultation-related transactions, or other paid services. Payments may be processed through third-party payment providers, including Razorpay.</p>
        ...
        <p><strong className="font-semibold text-ink-900">Refunds and billing.</strong> Refund eligibility, cancellations, subscription charges, consultation fees, service charges, and billing disputes are governed by DokLynk's applicable payment and refund policies.</p>
        <p>DokLynk reserves the right to modify pricing, subscription plans, or paid offerings at any time.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>All rights, title, and interest in the Platform, including software, user interfaces, visual assets, branding, logos, trademarks, design systems, and documentation, are owned by DokLynk or its licensors.</p>
  ...
  },
  {
    ...
    title: "Privacy",
    body: (
      <p>Your use of DokLynk is governed by the <a href="/privacy" className="font-semibold text-brand-700 hover:underline">DokLynk Privacy Policy</a>. The Privacy Policy explains how personal information is collected, used, stored, shared, and protected.</p>
    ),
  },
  {
    ...
    body: (
      <>
        <p>DokLynk may integrate with third-party providers, including:</p>
        <Bullets items={[
        ...
        <p>DokLynk is not responsible for the practices, policies, or actions of third-party services.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>DokLynk strives to maintain reliable platform availability. However, we do not guarantee:</p>
        <Bullets items={[
  ...
  },
  {
    ...
    body: (
      <>
        <p>DokLynk may suspend, restrict, remove, or terminate access to the Platform where users:</p>
        <Bullets items={[
          "Violate these Terms",
        ...
        <p>DokLynk may investigate suspected violations and take appropriate action.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>If the user signs in again using the same credentials during this period, the account may be restored. After six (6) months, account data may be permanently deleted according to DokLynk's retention procedures.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>DokLynk is provided on an "as is" and "as available" basis. DokLynk does not guarantee:</p>
        <Bullets items={[
  ...
  },
  {
    ...
    body: (
      <>
        <p>To the maximum extent permitted by law, DokLynk and its affiliates shall not be liable for:</p>
        <Bullets items={[
          "Indirect damages",
  ...
  },
  {
    ...
    body: (
      <>
        <p>You agree to defend, indemnify, and hold harmless DokLynk, its founders, affiliates, officers, employees, contractors, and representatives from claims, damages, liabilities, costs, and expenses arising from:</p>
        <Bullets items={[
  ...
  },
  {
    ...
    body: (
      <p>DokLynk may update these Terms from time to time. Material changes will be communicated through the Platform or other appropriate channels before becoming effective. Continued use of the Platform after changes become effective constitutes acceptance of the updated Terms.</p>
    ),
  },
  {
    id: "governing-law",
